...
static t_class *neumltcdec_class;
...
void setup_neum0x2eltc0x2edec_tilde(void)
{
    neumltcdec_class = class_new(gensym("neum.ltc.dec~"), (t_newmethod)ltc_new, (t_method)ltc_free, sizeof(t_ltc), 0, A_GIMME, 0);
    CLASS_MAINSIGNALIN(neumltcdec_class, t_ltc, x_val);
    class_addmethod(neumltcdec_class, (t_method)ltc_dsp, gensym("dsp"), A_CANT, 0);
}
...
void *ltc_new(t_symbol *s, int argc, t_atom *argv)
{
    t_ltc *x = (t_ltc *)pd_new(neumltcdec_class);
